...
const Navbar = () => {
    let {getUser, nameUser} = useContext(LoginContext) 
    ...
    return (
        <div className='h-screen w-1/5'  >
            <div className='w-full p-5 flex flex-col justify-center items-center' style={{height: '28%'}}>
                ...
                <span className='text_normal mt-4 uppercase'> { nameUser} </span>
            </div>
            ...
            <div className='' style={{height: '50%'}}>
                <ul className='h-full w-full flex justify-around  flex-col '>                                                                            
                    ...
                    <NavLink activeClassName="nav_active bg-blue-200  text-blue-500 font-bold " className='flex font-semibold text_normal  cursor-pointer nav_item  '  to="/estudiante" exact >
                        <div className='flex py-4'>
                            <AiOutlineTeam  size={25}  className='mx-5 '  />  <p   >Estudiantes </p> 
                        </div>
                    </NavLink>

                    <NavLink activeClassName="nav_active bg-blue-200  text-blue-500 font-bold  "className='flex font-semibold text_normal  cursor-pointer nav_item  ' to="/cita"  >
                        <div className='flex py-4'>
